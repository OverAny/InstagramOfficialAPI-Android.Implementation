 ...
 * 
 */
public class InstagramApp1 {

	private InstagramSession1 mSession;
	...
	public InstagramApp1(MainActivity context, String clientId, String clientSecret,
                         String callbackUrl) {
		...
		mCtx = context;
		mSession = new InstagramSession1(context);
		...
		mAuthUrl = AUTH_URL
				...
				+ "&redirect_uri="
				+ mCallbackUrl
				+ "&response_type=code&display=touch&scope=relationships+follower_list";
